        ...
        <div style={{ background: '#F8FAFC', minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '2rem' }}>
            ...
            >
                <div style={{ textAlign: 'center', marginBottom: '3rem' }}>
                    ...
                    <h2 style={{ fontSize: '2rem', fontWeight: '900', color: '#0F172A', marginBottom: '0.5rem' }}>Bem-vindo de volta</h2>
                    <p style={{ color: '#64748b' }}>Aceda à sua conta para gerir o seu crédito.</p>
                </div>
                ...
                <form onSubmit={handleLogin} style={{ display: 'grid', gap: '1.5rem' }}>
                    ...
                    <div>
                        <label style={{ display: 'block', marginBottom: '0.5rem', fontWeight: '600', color: '#0F172A' }}>Password</label>
                        <div style={{ position: 'relative' }}>
